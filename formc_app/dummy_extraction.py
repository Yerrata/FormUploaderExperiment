...
DUMMY_PROFILES: dict[str, dict[str, tuple[str | None, str]]] = {
    "daniel": {
        ...
        "permanent_address": ("12 EXAMPLE STREET", "passport_dummy"),
        "permanent_city": ("SINGAPORE", "passport_dummy"),
        "permanent_country": ("SINGAPORE", "passport_dummy"),
    ...
    "elena": {
        ...
        "permanent_address": ("34 EXAMPLE AVENUE", "passport_dummy"),
        "permanent_city": ("ZAGREB", "passport_dummy"),
        "permanent_country": ("CROATIA", "passport_dummy"),
    ...
    "aiko": {
        ...
        "permanent_address": ("56 EXAMPLE ROAD", "passport_dummy"),
        "permanent_city": ("TOKYO", "passport_dummy"),
        "permanent_country": ("JAPAN", "passport_dummy"),
